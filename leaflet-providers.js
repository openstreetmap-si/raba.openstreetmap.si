(function () {
	...
	map.addLayer(PistesTiles);*/
		...
		GursDof025: {
			...
			options: {
				attribution: 'DOF025 CC-BY <a href="https://www.gov.si/drzavni-organi/organi-v-sestavi/geodetska-uprava/" target="_blank">GURS</a> (hosted by (hosted by <a href="http://level2.si/sl/pogoji-uporabe-spletnih-servisov/">Level2</a>)',
				minZoom: 8,
				maxZoom: 20
			}
		},
